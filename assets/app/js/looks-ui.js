  ...
  function createController(deps) {
    ...
    root.innerHTML = `
      <section class="vm-appearance-section" id="lookPresetSection"><h3 class="vm-section-label">Looks</h3><div id="lookPresetControls"></div>
        ...
        <div id="lookNameForm" hidden><div class="vm-field-row"><label class="vm-field-label" for="lookNameInput">Look name</label><div class="vm-field-control"><input id="lookNameInput" maxlength="60" autocomplete="off"></div></div><div class="vm-popover__actions"><button id="lookNameConfirm" class="secondary" type="button">Save</button><button id="lookNameCancel" class="secondary" type="button">Cancel</button></div></div>
        <details id="lookSaveDetails"><summary class="inspectorSubsectionSummary">Save & share</summary>
          <div class="vm-popover__actions"><button id="lookUpdate" class="secondary" type="button" disabled>Update saved</button><button id="lookRename" class="secondary" type="button" disabled>Rename</button><button id="lookDelete" class="secondary" type="button" disabled>Delete</button></div>
          <div class="vm-popover__actions"><button id="lookExport" class="secondary" type="button">Export look</button><button id="lookImport" class="secondary" type="button">Import look</button></div>
          <div class="vm-popover__actions"><button id="lookDefault" class="secondary" type="button">Set as default</button><button id="lookClearDefault" class="secondary" type="button" hidden>Use last appearance</button></div>
