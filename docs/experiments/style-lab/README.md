...
- `getSurfaceAppearanceTargets()` resolves the current orbital-group scope. A look application must use it and leave `iso`, `isoPending`, `autoIsoEnabled`, visibility, and recipes intact.
