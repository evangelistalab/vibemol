...
check:
	...
	python3 -m py_compile api/vibemol_client.py tests/e2e/helpers.py tests/e2e/smoke.py tests/e2e/premerge.py tests/e2e/sessions.py tests/e2e/looks.py tests/e2e/surface_shadows.py tests/e2e/camera_depth.py tests/e2e/edit_picking.py tests/e2e/mode_consistency.py tests/e2e/style_studio.py tests/e2e/appearance_scopes.py tests/e2e/appearance_controls.py tests/e2e/floating_panels.py tests/e2e/workbench.py tests/e2e/workbench_consistency.py tests/e2e/workbench_bar.py tools/render_look_previews.py tools/profile_nacl_edit.py
	git diff --check
